                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
                        {[
                            { 
                                href: "/modules/math", 
                                title: "Matemática", 
                                description: "Aprofunde seus conhecimentos em matemática.", 
                                icon: Calculator, 
                            ...
                            { 
                                href: "/modules/prog", 
                                title: "Programação", 
                                description: "Explore o mundo da programação e desenvolvimento.", 
                                icon: Cpu, 
                            ...
                            { 
                                ...
                                title: "Inglês", 
                                description: "Aprenda e pratique o inglês de forma interativa.", 
                                icon: BookText, 
